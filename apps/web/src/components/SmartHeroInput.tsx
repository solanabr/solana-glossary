...
export function SmartHeroInput({ onSelectTerm }: SmartHeroInputProps) {
  ...
  const handleExplainCode = useCallback(() => {
    // Store code in sessionStorage for the explain page to pick up
    sessionStorage.setItem("explain-code-input", query);
