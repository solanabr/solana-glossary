...
export const metadata: Metadata = {
  title: "MCP — Solana Glossary",
  description: "Mock page for MCP section (coming soon).",
};
      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-6 py-12">
        <div className="rounded-2xl border border-sol-line bg-sol-surface-elevated/80 p-6 sm:p-8">
          ...
          <p className="text-sol-subtle leading-relaxed">
            Esta pagina ainda e um mock. Em breve vamos publicar a documentacao
            e os fluxos reais de MCP.
          </p>
        </div>
      </main>
    </div>
