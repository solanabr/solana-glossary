...
const translations = {
  ...
  pt: {
    ...
    "hero.helper_text": 'Tente: "PDA", "Turbine", ou cole código Anchor',
  ...
  es: {
    ...
    "hero.helper_text": 'Prueba: "PDA", "Turbine", o pega código Anchor',
    "btn.copilot": "IA Copilot",
    "btn.explain_code": "Explicar Código",
